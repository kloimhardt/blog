...
The ROOT library [1], a software maintained by CERN, the European center for particle research, has been used for data analysis well before the turn of the millenium [2]. This article frequently refers to a public tutorial introducing the library.  The example, which is reproduced here, shows how to plot a simple graph with ROOT in nine lines of Python.
...
An integral part of our analysis of this example is the translation and comparison of the Python code to Clojure [3], a dialect of the Lisp family of languages currently used mainly for commercial web applications [4].
...
[2] https://cds.cern.ch/record/687164  
