...
This article refers to a public tutorial which introduces the ROOT library [1], a software maintained by CERN, the European center for particle research. The example uses ROOT to plot a simple graph, its nine lines of Python code, which are going to be analysed in the following, are reproduced here.
...
An integral part of our analysis is the translation and comparison of the Python code to Clojure [2], a dialect of the Lisp family of languages currently mainly used for commercial web applications [3].
