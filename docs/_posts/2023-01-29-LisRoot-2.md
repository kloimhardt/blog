...
The ROOT library [1], a software maintained by CERN, the European center for particle research, has been used for data analysis since well before the turn of the millenium [2]. This article frequently refers to a specific tutorial script which CERN provides as an introduction to the library. This publicly available example, which is reproduced here, shows how to plot a simple graph with ROOT in nine lines of Python.
...
An integral part of our discussion is the translation and comparison of this Python code to Clojure [3], a dialect of the Lisp family of languages currently used mainly for commercial web applications [4].
...
The code for the interop functionality, some 400 lines of self contained Ferret code, is made available free and open source [7].
...
[3] https://www.clojure.org  
[4] https://de.surveymonkey.com/stories/SM-f2XkbSKiS_2BDdJShL141pOQ_3D_3D/  
[5] https://cppyy.readthedocs.io/en/latest/  
[6] https://ferret-lang.org  
[7] https://github.com/kloimhardt/LisRoot  
[8] https://github.com/metosin/malli  
