...
This article frequently refers to a public tutorial introducing the ROOT library [1], a software maintained by CERN, the European center for particle research. The example, which is reproduced here, shows how to plot a simple graph with ROOT in nine lines of Python.
...
The code for the interop functionality, some 400 lines of self contained Ferret code, is made available free and open source [6].
