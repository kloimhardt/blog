...
-> Moleküle können unendlich gross werden.  
...
-> Das Bild stellt die Anordnung der Moleküle im Phasenraum, das Bestehen und Nichtbestehen von Molekülen vor.

2.202 Das Bild stellt eine mögliche Sachlage im logischen Raume dar.

-> Das Bild stellt eine mögliche Anordnung der Moleküle im Phasenraum dar.

3.032 Etwas „der Logik widersprechendes“ in der Sprache darstellen, kann man ebensowenig, wie in der Geometrie eine den Gesetzen des Raumes widersprechende Figur durch ihre Koordinaten darstellen; oder die Koordinaten eines Punktes angeben, welcher nicht existiert.

-> Etwas "der Chemie widersprechendes" in der chemischen Notation mit Valenzstrichen darzustellen, kann man ebensowenig, wie ...
...
-> Sehr klar wird das Wesen der chemischen Notation, wenn wir es uns, statt aus Buchstaben und Strichen, aus Kugeln und Stäben im Raum zusammengesetzt denken.
Die gegenseitige räumliche Lage dieser Kugeln drückt dann den Sinn der Notation aus.

Die folgenden Aussagen illustrieren weiter, unübersetzt, Wittgensteins enge Anlehnung and die Physik:
...
Ich dachte immer, dass es sich hierbei um eine Tautologie handelt. Denn wenn die Notation etwas nicht zulässt, kann man nix darüber schreiben. Ich glaube das ist die Lesart von Carnap.
...
Irgendwie erinnert mich das Ganze an das Ergebnis Gödels, der zeigen konnte, dass es wahre Sätze gibt, die sich nicht beweisen lassen. Das fand Gödel aber erst über zehn Jahre nach dem Tractatus raus. Ausserdem bin ich nicht schlau genug, um die Verbindung von Gödel und Wittgenstein wirklich hinzukriegen.

### Ethik

Manche würden "Sinn" vielleicht mit der Frage "welchen Weg zu Gott?" übersetzen. Und in der Tat wäre es gut, über die Frage "welchen Weg zu Gott?" zu reden (im Konjunktiv) um das Schweigen als Lösung zu sehen. Motto: "schau ma mal, er wird sich schon zeigen". Wenn Schweigen (und Schauen) nicht als Lösung angesehen wird beginnen die Waffen zu sprechen.

6.42 Darum kann es auch keine Sätze der Ethik geben. Sätze können nichts Höheres ausdrücken.

"Conan, was ist der Sinn des Lebens?" "Zu kämpfen mit dem Feind, ihn zu verfolgen und zu vernichten und ..." weiter trau ich mich gar nicht mehr schreiben.
