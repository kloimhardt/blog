...
And indeed, this is a very sensible postulate, as past empirical facts do not change when a new theory appears. Maybe we get a better explanation, but the run-of-the-mill observations remain the same. This is the necessary firm ground to discuss a shaky new theory.
