...
Those postulates are based on empirical evidence in the laboratory. Especially the "pure" in randomness-postulate (2) is based on the painstaking exclusion of many conceivable alternatives.
